...
class Help extends Command {
  ...
  async run(ctx, options) {
    ...
    const embed = this.client
      ...
      .setDescription(
        "Join our [Discord Server](https://discord.gg/n4K3B7pDVF) for support and updates!"
      )
      .setFooter({
        text: "For more information about a command run @Lanya help <command>",
      });
