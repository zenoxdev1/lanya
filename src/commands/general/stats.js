  ...
  async run(ctx) {
    ...
    const embed = this.client
      ...
      .addFields({
        name: "Links",
        value: [
          ":star: [GitHub Repository](https://github.com/birajrai/lanya)",
          ":robot: [Upvote me at top.gg](https://top.gg/bot/860165618896207872)",
          `:envelope_with_arrow: [Invite me to your server](${client.invite})`,
          ":video_game: [Join our Discord Server](https://discord.gg/n4K3B7pDVF)",
        ].join("\n"),
        inline: true,
      });
