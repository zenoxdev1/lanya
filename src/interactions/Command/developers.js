...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand.setName('help').setDescription('Get information about the developers category commands')
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('eval')
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addStringOption(option =>
                    option.setName('badge').setDescription('Choose your badge').setRequired(true)
                )
        )
        .addSubcommand(subcommand =>
            subcommand
        ...
        .addSubcommand(subcommand => subcommand.setName('servers').setDescription('See all servers from this shard')),
    /**
     * @param {Client} client
